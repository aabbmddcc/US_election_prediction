...
Our model predicts that Donald Trump will get **49.7%** of the scaled popular vote in the next election. This prediction was based on several polls' average values, but it should be considered describing the limitations of the model.
